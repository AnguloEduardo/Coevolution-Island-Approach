...
# Calculate Weight value to find fittest individuals
...
def runGA():
    ...
    for i in range(max_generations):
        ...
        crossover = apply_crossover(parents, backpack_capacity, crossover_probability, mutation_probability)
        # Calculate Fitness of population
        population = calculate_fitness(crossover, items, max_weight)
        # Find fittest candidates
